...
class CubicRegression:
    def __init__(self, x, y):
        calc = Operations(x, y)
        self.matrix_A = np.array([[calc.sum_x_cubed(), calc.sum_x_squared(), calc.sum_x(), calc.get_n()],
                                  [calc.sum_x_to_the_fourth(), calc.sum_x_cubed(), calc.sum_x_squared(), calc.sum_x()],
                                  [calc.sum_x_to_the_fifth(), calc.sum_x_to_the_fourth(), calc.sum_x_cubed(), calc.sum_x_squared()],
                                  [calc.sum_x_to_the_sixth(), calc.sum_x_to_the_fifth(), calc.sum_x_to_the_fourth(), calc.sum_x_cubed()]])

        self.matrix_B = np.array([calc.sum_y(), calc.sum_x_times_sum_y(), calc.sum_x_squared_times_sum_y(), calc.sum_x_cubed_times_sum_y()])
    ...
    def print_equation(self):
        print("Y = ", self.a, "x cubed + ", self.b, "x squared + ", self.c, "x + ", self.d)
